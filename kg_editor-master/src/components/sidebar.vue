    ...
    <v-app>
      <v-expansion-panels multiple tile class="panel" v-model="bigPanels">
                  ...
                  <el-row type="flex" :gutter="20">
                    <el-col :span="24"
                      ...
                      <!-- <el-input
                        ...
                        size="mini"
                      ></el-input> -->
                      <el-select v-model="node.type" size="mini" style="width: 81%">
                        <el-option label="LOCATIONS" value="LOCATIONS"></el-option>
                        <el-option label="STYLE" value="STYLE"></el-option>
                        <el-option label="TASK_OBJECTIVE" value="TASK_OBJECTIVE"></el-option>
                        <el-option label="TIMESTAMP" value="TIMESTAMP"></el-option>
                        <el-option label="ACTION_POSTURE" value="ACTION_POSTURE"></el-option>
                        <el-option label="USER_PROPERTY" value="USER_PROPERTY"></el-option>
                      </el-select>
                    </el-col>
                  </el-row>
                  <br>
                  ...
                  <el-row type="flex" :gutter="20">
                    <el-col :span="24"
                      ...
                      <!-- <el-input
                        ...
                        size="mini"
                      ></el-input> -->
                      <button class="node-change-button" @click="nodeChange" style="">确认修改</button>
                    </el-col>
                  </el-row>
                  <!-- <el-row type="flex" :gutter="20">
                    <el-col :span="12"
        ...
        <v-expansion-panel class="panel" tile>
          ...
          <v-expansion-panel-content>
            <div class="hint">
              <div class="hint-title">提示标题</div>
              <div class="hint-time">当前时间</div>
              <div class="hint-status">消息状态</div>
            </div>
            <div class="hint">
              <div class="hint-title">提示标题</div>
              <div class="hint-time">当前时间</div>
