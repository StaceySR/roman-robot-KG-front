  ...
  <div class="toolbar">
    <v-toolbar height="50">
      ...
      <div class="robot-info">
        <div class="robot-name">艾米（XA-002）</div>
        <div class="robot-detail">
          <div class="robot-location">
            <label><img class="label-img" src="../../static/assets/online-location.png"></label>
            <label class="location-content">商场一层 服务台</label>
          </div>
          <div class="robot-status">
            <label><img class="label-img" src="../../static/assets/online-status.png"></label>
            <label class="status-content">工作中-正常</label>
          </div>
        </div>
      </div>
...
.robot-location .location-content,
.robot-status .status-content {
  height: 15px;
  display: inline-block;
  font-size: 8px;
  vertical-align: middle;
