...
import { ws, eventemitter, msgId } from './ws.js'
...
export default class Robot {
  ...
  ask (sentence) {
    ...
    const jsonMessage = JSON.stringify(message)
    msgId.ask = message.id
    console.debug('ask_id: ' + msgId.ask)
    ws.send(jsonMessage)
    console.log('send message: ' + jsonMessage)
  ...
  async ask2 (sentence) {
    ...
    eventemitter.on('replyEvent', (robotReply) => {
      console.log('replyEvent: ' + robotReply)
      reply = robotReply
    })
